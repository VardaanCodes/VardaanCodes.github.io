    ...
    try {
      ...
      if (tagsString) {
        ...
        const defaultIcons = {
          ...
          HTML: "fab fa-html5",
          CSS: "fab fa-css3-alt",
          "Fusion 360": "fas fa-cube",
          Solidworks: "fas fa-cubes",
          AutoCAD: "fas fa-drafting-compass",
          EasyEDA: "fas fa-microchip",
          ESP32: "fas fa-microchip",
          "Stepper Motors": "fas fa-cogs",
          "CNC/3D Printing": "fas fa-print",
          "3D Printing": "fas fa-print",
          "Power Electronics": "fas fa-bolt",
          LaTeX: "fas fa-file-alt",
          "Computer Vision": "fas fa-eye",
          "Image Processing": "fas fa-image",
          BMS: "fas fa-battery-full",
          Battery: "fas fa-battery-full",
          Research: "fas fa-flask",
          "Mechanical Design": "fas fa-drafting-compass",
          CAD: "fas fa-drafting-compass",
          FEA: "fas fa-chart-area",
          "Embedded Firmware": "fas fa-microchip",
          Ansys: "fas fa-wind",
          Numpy: "fas fa-layer-group",
          Pandas: "fas fa-table",
          Sympy: "fas fa-calculator",
          Scipy: "fas fa-flask",
          "Telescope Control": "fas fa-satellite-dish",
          Astrophotography: "fas fa-camera-retro",
          Stacking: "fas fa-layer-group",
          Working: "fas fa-tools",
          Finished: "fas fa-check-circle",
          "To Start": "fas fa-hourglass-start",
        };
